// Enhanced CreateTeam with API Integration
...
import 'package:booking_application/views/Games/GameViews/game_type_selection.dart';
...
class _CreateTeamState extends State<CreateTeam> {
  ...
  void _proceedToNextStep() {
    ...
    final individualGames = [SportType.chess, SportType.golf];

    if (individualGames.contains(selectedSport)) {
      _showSnackBar("You selected individual game!", Icons.warning,
          const Color.fromARGB(255, 196, 190, 25));
    } else {
