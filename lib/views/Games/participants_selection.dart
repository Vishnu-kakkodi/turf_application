...
// import 'package:booking_application/views/Games/games_view_screen.dart' hide Team, GameProvider;
...
//   final int? setFormat;
//   final String? categoryId; // Add categoryId for team search
...
//   // New variables for singles/teams selection
...
//           print("oooooooooooooooooooooooooooooooooooooooooooooo$query");
//               print("hhhhhhhhhhhhhhhhhhhhh${query.isEmpty}");
//                             print("hhhhhhhhhhhhhhhhhhhhh${widget.categoryId}");
...
//       print("oooooooooooooooooooooooooooooooooooooooooooooo${response.body}");
...
//       if (isTeamBased) {
//         print("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk$isTeamBased");
//         _searchTeams(query);
//       } else {
//         _searchUsers(query);
//       }
...
//   try {
//     // TODO: Replace with actual userId from your auth system
//     const String userId = '6884add9466d0e6a78245550'; // Get from your auth provider
    
//     // Generate match name based on participants
//     String matchName;
//     if (isTeamBased) {
...
//     // Determine scoring method based on sport
...
//     } else if (sportName == 'badminton' || sportName == 'tennis') {
//       scoringMethod = 'Point Based';
//     } else {
//       scoringMethod = 'Point Based'; // Default
//     }
...
//       type: 'friendly', // or 'tournament' based on your logic
//     );
...
class _ParticipantSelectionScreenState extends State<ParticipantSelectionScreen> {
  ...
  void _startMatch(bool isTeamBased) async {
    ...
    try {
      const String userId = '6884add9466d0e6a78245550';
